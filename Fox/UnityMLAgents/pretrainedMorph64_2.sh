...
generations=(
#511 # alle med 0.3 er ferdig her
1023 # ikke ferdig
)
...
for mor in "${morphs[@]}"; do
    python3 EvolvingMLAgents.py 0 0 0 0 0 0 --pretrainedMorphology $gen 2 /home/steinboe/MasterThesis/resultsLinux/$dir/subGen${gen}Morph${mor} 64 4096 &
    wait
done
done
done
