...
def getSolution(data, solutionNr=0):
...
def getSolutions(data, solutions=[0]):
    """
    dir
    ...
    for i in range(len(solutions)):
        individuals.append(getSolution(data,solutions[i]))
...
class EvolutionaryAlgorithm:
    ...
    def findMorphologies(self, numMorph, checkpointData=None):
        ...
        indWithMorphToKeep = self.toolbox.parentSelection(self.pop, numMorph)
        return [ind.morphologyParams for ind in indWithMorphToKeep]
